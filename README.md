...
Useful for jupyter notebook and tensorboard, amongst other things.
 ...
 - **start_gpu.sh** is intended for submitting a job and setting up ssh forwarding with 2 GPUs
...
You can always edit `params_gpu.sh` later to change these configuration options. 
